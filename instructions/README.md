...
| [33](./33-nvg.md) | StyxNvg | `/nvg` | Toggleable personal night vision via a camera-pinned light source |
...
| [28](./28-auto-admin.md) | StyxAutoAdmin | (none) | **Test/sandbox only** — auto-adds joining players to a configured perm group (`admin` by default). Default OFF. |
